...
export default function EditMediaDescription({stored_element, location, lastRoute, prevRoute}) {
    // ======= Hooks
                            ...
                            items: [
                                {
                                    title: "Description",
                                    content: [
                                        <input type="text" name="description" value={localStorageData} onChange={handelChangeLocalStorageData} placeholder="..."/>
                                    ]
                                }
                            ]
                        }
