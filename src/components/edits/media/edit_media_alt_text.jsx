...
export default function EditMediaAltText({stored_element, location, lastRoute, prevRoute}) {
    // ======= Hooks
                            ...
                            items: [
                                {
                                    ...
                                    content: [
                                        <input type="text" name="alt_text" value={localStorageData} onChange={handelChangeLocalStorageData} placeholder="..."/>
                                    ]
                                }
                            ]
                        }
