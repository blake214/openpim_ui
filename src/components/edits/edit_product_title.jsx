		...
		<>
			...
			<div className={styles.body_container}>
                <KeyValueBlock title="Short">
                    <input className={styles.input_bar} type="text" name="short" value={formData.short} onChange={handleFormChange} placeholder="..."/>                   
                </KeyValueBlock>
                <KeyValueBlock title="Long">
                    <input className={styles.input_bar} type="text" name="long" value={formData.long} onChange={handleFormChange} placeholder="..."/>                   
                </KeyValueBlock>
			</div>
            <br/>
