...
export default function EditUserEmailsPrimaryEmail({stored_element}) {
	...
	return (
		<>
			...
			<div className={styles.body_container}>
                <KeyValueBlock title="Primary Email">
                    <input type="email" name="primary_email" value={formData} onChange={handleFormChange} placeholder="Primary Email"/>                   
                </KeyValueBlock>
			</div>
            <br/>
