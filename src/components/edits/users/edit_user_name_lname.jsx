...
export default function EditUserNameLname({stored_element}) {
	...
	return (
		<>
			...
			<div className={styles.body_container}>
                <KeyValueBlock title="Last name">
                    <input type="text" name="lname" value={formData} onChange={handleFormChange} placeholder="Last Name"/>                   
                </KeyValueBlock>
			</div>
            <br/>
