...
export default function EditUserPasswordPassword({stored_element, location, lastRoute, prevRoute}) {
    ...
    const handelChangeLocalStorageData = (event) => {
        ...
        if(name == "password") setLocalStorageData(value)
    };
    // ======= Change Handlers
                            ...
                            items: [
                                {
                                    title: "Password",
                                    content: [
                                        <input type="password" name="password" value={localStorageData} onChange={handelChangeLocalStorageData} placeholder="..."/>
                                    ]
                                }
                            ]
                        },
                            ...
                            items: [
                                {
                                    ...
                                    content: [
                                        <input type="password" name="password_repeat" value={passwordRepeat} onChange={handelChangeLocalStorageData} placeholder="..."/>
                                    ]
                                }
                            ]
                        }
