...
export default function EditVideoExternalUrl({stored_element, location, lastRoute, prevRoute}) {
    // ======= Hooks
                            ...
                            items: [
                                {
                                    title: "Youtube Url",
                                    content: [
                                        <input type="url" name="external_url" value={localStorageData} onChange={handelChangeLocalStorageData} placeholder="..."/>
                                    ]
                                }
                            ]
                        }
