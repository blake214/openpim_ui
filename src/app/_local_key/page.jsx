...
import CreateProductChangePage from './create_product_change_page/page';
...
export default function LocalKeyPage() {
    // ======= Hooks
    ...
    */
    ...
    return (
        ...
        {storedElement.type == "create_product" && <CreateProductPage
            ...
            prevRoute={prevRoute}
        />}
        {storedElement.type == "create_product_change" && <CreateProductChangePage
            stored_element={storedElement}
            location={location}
            lastRoute={lastRoute}
            prevRoute={prevRoute}
