...
export default function DashPage() {
    ...
    const handleCreateUnregisteredEntity = () => {
        ...
        router.push(`products/create/${create_unregistered_entity_id}`) // The path just needs to go to _handel somehow
    }
    // ======= Create unregistered entity
    ...
    const handleCreateVideo = () => {
        ...
        router.push(`products/create/${create_video_id}`) // The path just needs to go to _handel somehow
    }
    // ======= Create video
    ...
    const handleCreatePdf = async () => {
        ...
        router.push(`products/create/${create_pdf_id}`) // The path just needs to go to _handel somehow
    }
    // ======= Create pdf
    ...
    const handleCreateImage = async () => {
        ...
        router.push(`products/create/${create_image_id}`) // The path just needs to go to _handel somehow
    }
    // ======= Create image
